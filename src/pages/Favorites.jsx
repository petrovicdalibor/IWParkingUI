...
const Favorites = () => {
  ...
  return (
    <>
      ...
      <Grid container>
        {userContext.isFetchingFavorites ? (
          <Grid
            item
            container
            display={"flex"}
            justifyContent={userContext.isFetchingFavorites && "center"}
            alignItems={userContext.isFetchingFavorites && "center"}
            height={userContext.isFetchingFavorites && "60vh"}
          >
            <CircularProgress />
          </Grid>
        ) : (
